...
// VC++ Express版＋WDKを使用している場合、このコメントアウトを除外します
...
//このプロジェクトはVC++ 2005 Express＋Platform SDKのATL 3.0用に生成されました。
//ほかのバージョンのVC++やATLで利用する場合は以下のラインをコメントアウトしてください。
//#define _WTL_SUPPORT_SDK_ATL3

//VS2005 Express＋SDK ATLのサポート
